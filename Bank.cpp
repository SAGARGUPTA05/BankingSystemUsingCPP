...
class temp{
    ...
    void createAccount();   // declaration of create account function
    void depositAmount();   // declaration of depositAmount function
    void withdrawAmount();  // declaration of withdrawAmount function
    void checkInfo();       // declaration of checkInfo function
};
